...
`,j=n().div.withConfig({componentId:"sc-94fdaca9-3"})`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,S=n().div.withConfig({componentId:"sc-94fdaca9-4"})`
  height: 120px;
  padding: 8px;
  border: 1px solid #dddddd;
  border-radius: var(--border-radius);
`,w=n().img.withConfig({componentId:"sc-94fdaca9-5"})`
  height: 100%;
`,P=n().div.withConfig({componentId:"sc-94fdaca9-6"})`
  display: flex;
  flex-direction: column;
  gap: 10px;
  width: 100%;
  position: relative;
`,T=n().div.withConfig({componentId:"sc-94fdaca9-7"})`
  display: none;
  gap: 8px;
...
`,C=n().div.withConfig({componentId:"sc-94fdaca9-8"})`
  cursor: pointer;
...
`,_=n().div.withConfig({componentId:"sc-94fdaca9-9"})`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,I=n().div.withConfig({componentId:"sc-94fdaca9-10"})`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,k=n().div.withConfig({componentId:"sc-94fdaca9-11"})`
  display: flex;
  justify-content: space-between;
  align-items: center;

  width: 100%;
`,q=n().div.withConfig({componentId:"sc-94fdaca9-12"})`
  display: flex;
  align-items: center;
  gap: 10px;
