exports.id=597,exports.ids=[597],exports.modules={4500:(e,t,a)=>{"use strict";a.d(t,{Z:()=>Button});var r=a(997),n=a(7518),i=a.n(n);function Button({text:e,classname:t="",as:a="",style:n={},onClick:i}){return r.jsx(o,{className:`${t}`,as:a,style:n,onClick:i,children:r.jsx("span",{className:"buttonText",children:e})})}let o=i().button.withConfig({componentId:"sc-c481b9b8-0"})`
  padding: 8px 12px;
  background: var(--gray);
  color: #ffffff;
...
`},9869:(e,t,a)=>{"use strict";a.a(e,async(e,r)=>{try{a.d(t,{Z:()=>UserMenuWrap});var n=a(997),i=a(7518),o=a.n(i),s=a(6022),c=a(1163),d=a(6689),l=a(1664),p=a.n(l),u=a(3746),g=a(1938),h=e([u]);function UserMenuWrap({closeUserMenuWrapFn:e}){let t=(0,s.useDispatch)(),a=(0,c.useRouter)();return(0,d.useEffect)(()=>(window.addEventListener("click",e),()=>{window.removeEventListener("click",e)}),[]),(0,n.jsxs)(x,{id:"userMenuWrap",children:[n.jsx("li",{className:"menuWrapBtn normalText",onClick:e=>{(0,u.gy)(),t((0,g.TX)()),a.reload()},children:"Logout"}),n.jsx("li",{className:"menuWrapBtn mobileOnly normalText",children:n.jsx(p(),{href:"/postEditor/new",children:"새 글 작성"})})]})}u=(h.then?(await h)():h)[0];let x=o().ul.withConfig({componentId:"sc-14edc0f3-0"})`
  display: flex;
...
`,v=s().div.withConfig({componentId:"sc-9c245057-1"})`
  display: flex;
  ...
  height: 100%;
  position: relative;
`,y=s()(c.cur).withConfig({componentId:"sc-9c245057-2"})`
  font-size: 20px;
...
`,b=s().h1.withConfig({componentId:"sc-9c245057-3"})`
...
`,w=s().div.withConfig({componentId:"sc-9c245057-4"})`
  display: flex;
  align-items: center;
  gap: 12px;

  position: relative;
`,k=s().button.withConfig({componentId:"sc-9c245057-5"})`
  display: flex;
  align-items: center;
...
`,d=s},1410:(e,t,a)=>{"use strict";a.d(t,{Z:()=>LinkButton});var r=a(997),n=a(7518),i=a.n(n),o=a(1664),s=a.n(o);function LinkButton({text:e,classname:t="",href:a}){return r.jsx(c,{className:`${t} buttonText`,href:a,children:e})}let c=i()(s()).withConfig({componentId:"sc-f92dd601-0"})`
  padding: 8px 12px;
...
`},533:(e,t,a)=>{"use strict";a.a(e,async(e,r)=>{try{a.d(t,{Z:()=>LoginModal});var n=a(997),i=a(7518),o=a.n(i),s=a(6689),c=a(1163),d=a(4304),l=a(914),p=a(5352),u=a(4500),g=e([d]);function LoginModal({modalHandler:e}){let t=(0,c.useRouter)(),a=(0,s.useRef)(null),[r,i]=(0,l.Z)(""),[o,g]=(0,l.Z)(""),loginFn=async a=>{a.preventDefault();let n=a.currentTarget;if(n.disabled=!0,!r)return alert("아이디를 입력해주세요.");if(!o)return alert("비밀번호를 입력해주세요.");try{await d.Z.post("/apis/users/login",{id:r,password:o}),t.reload(),e(a)}catch(e){console.error(e)}finally{n.disabled=!1}};return(0,s.useEffect)(()=>{a.current.focus()},[]),(0,n.jsxs)(h,{children:[n.jsx(x,{onClick:e}),n.jsx(f,{children:(0,n.jsxs)(m,{children:[n.jsx("h2",{className:"headline",children:"Login"}),n.jsx(p.Z,{placeholder:"Username",defaultValue:r,onChange:i,style:{width:"100%",color:"var(--gray-l)"},onKeyUp:e=>("Enter"===e.key)??loginFn(),ref:a,border:"bottom"}),n.jsx(p.Z,{placeholder:"Password",type:"password",defaultValue:o,onChange:g,style:{width:"100%",color:"var(--gray-l)"},onKeyUp:e=>("Enter"===e.key)??loginFn(),border:"bottom"}),n.jsx(u.Z,{text:"Login",onClick:loginFn,style:{padding:"12px",marginTop:"10px",background:"var(--primary-color)",color:"var(--primary-text-color)"}})]})})]})}d=(g.then?(await g)():g)[0];let h=o().div.withConfig({componentId:"sc-8bd9eade-0"})`
  ...
  left: 0;
  top: 0;
`,x=o().div.withConfig({componentId:"sc-8bd9eade-1"})`
  width: 100%;
  height: 100%;
  backdrop-filter: blur(5px);
  position: fixed;
  left: 0;
  top: 0;
`,f=o().div.withConfig({componentId:"sc-8bd9eade-2"})`
  width: 400px;
  height: 280px;
  max-width: 90%;
  padding: 0 20px;
  ...
  position: relative;
  z-index: 1;
`,m=o().form.withConfig({componentId:"sc-8bd9eade-3"})`
  display: flex;
  flex-direction: column;
  justify-content: center;
  gap: 10px;
...
`;r()}catch(e){r(e)}})},2724:(e,t,a)=>{"use strict";a.d(t,{Z:()=>Modal});var r=a(997);function Modal({component:e,modalView:t}){return r.jsx(r.Fragment,{})}a(6405)},3764:(e,t,a)=>{"use strict";a.d(t,{Z:()=>NavButton});var r=a(997),n=a(7518),i=a.n(n),o=a(1664),s=a.n(o),c=a(1163);function NavButton({text:e,path:t,active:a,subText:n,subTextStyle:i}){let o=(0,c.useRouter)();return r.jsx(r.Fragment,{children:(0,r.jsxs)(d,{className:a||o.asPath===t?"active":"",href:t,children:[r.jsx("span",{children:e}),n?r.jsx("span",{style:i,children:n}):null]})})}let d=i()(s()).withConfig({componentId:"sc-b68c244b-0"})`
  display: flex;
  align-items: center;
...
`,u=o().div.withConfig({componentId:"sc-fbcb8181-1"})`
  @media all and (max-width: ${"767px"}) {
    display: none;
...
`,x=d().main.withConfig({componentId:"sc-51d2e077-1"})`
  display: flex;
  gap: 40px;

  width: 100%;
  padding-bottom: 60px;
`,f=d().aside.withConfig({componentId:"sc-51d2e077-2"})`
  position: fixed;
  left: 0;
  top: 0;
  z-index: 2;
